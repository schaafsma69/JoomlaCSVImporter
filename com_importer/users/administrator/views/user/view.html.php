 ...
 * @since  1.6
 */
class JoomlappViewUser extends JViewLegacy
{
	protected $state;
	...
	protected function addToolbar()
	{
		...
		$canDo = JoomlappHelper::getActions();

		JToolBarHelper::title(JText::_('COM_JOOMLAPP_TITLE_USER'), 'user.png');
		...
		if ($this->state->params->get('save_history', 1) && $user->authorise('core.edit')) {
			JToolbarHelper::versions('com_joomlapp.user', $this->item->id);
		}
