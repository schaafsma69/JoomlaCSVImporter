...
/**
 * View class for a list of Joomlapp.
 *
 * @since  1.6
 */
class JoomlappViewUsers extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		JoomlappHelper::addSubmenu('users');
	...
	protected function addToolbar()
	{
		...
		$canDo = JoomlappHelper::getActions($state->get('filter.category_id'));

		JToolBarHelper::title(JText::_('COM_JOOMLAPP_TITLE_USERS'), 'users.png');
		...
		{
			JToolBarHelper::preferences('com_joomlapp');
		}

		// Set sidebar action - New in 3.0
		JHtmlSidebar::setAction('index.php?option=com_joomlapp&view=users');
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`user`' => JText::_('COM_JOOMLAPP_USERS_USER'),
		);
	}
}
